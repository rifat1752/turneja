    ...
    disableOnInteraction: false, // Keep autoplay even after user interacts
                ...
                {bannerImage.map((banner, index) => (
                    <SwiperSlide key={index}>
                       ...
                       <div  className='absolute   flex flex-col  items-start top-5  sm:top-0 left-0 pl-16 sm:w-5/6 md:w-3/5 xl:w-1/2  h-full justify-start bg-gradient-to-r from-purple-600 to-transparent'>
