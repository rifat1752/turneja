    ...
    disableOnInteraction: false, // Keep autoplay even after user interacts
                ...
                {bannerImage.map((banner, index) => (
                    <SwiperSlide key={index}>
                       ...
                       <p data-aos="fade-right" data-aos-duration="1000" className='text-slate-300 text-xs sm:text-base lg:text-xl  text-left mt-2 ms:mt-10 xl:mt-32 mr-10'>{banner.Description}</p>
                       <Link data-aos="fade-right" data-aos-duration="1000" to='/signup' className='banner-btn text-sm md:text-lg font-semibold w-28 sm:w-40 h-11  mt-5 py-3 sm:py-2 xl:mt-32'>Sign Up Now!</Link>
                       </div>
