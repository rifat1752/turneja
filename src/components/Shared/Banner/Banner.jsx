    ...
    disableOnInteraction: false, // Keep autoplay even after user interacts
                ...
                {bannerImage.map((banner, index) => (
                    <SwiperSlide key={index}>
                       ...
                       <p data-aos="fade-right" data-aos-duration="1000" className='text-slate-300 text-xs sm:text-base lg:text-xl  text-left mt-2 ms:mt-10 xl:mt-8 mr-10'>{banner.Description}</p>
